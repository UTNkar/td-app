import { FkB, FkDV, FkE, FkES,
         FkF, FkI, FkIT,
         FkK, FkM, FkMT,
         FkQ, FkSTS, FkW,
         FkX, FkGl2 } from '../../texts/Fadderka';
...
const FadderKaiter = [{ name: FkGl2.firstName, lastName: FkGl2.lastName, url:require('./gl2.jpg'), program: 'Gruppledare', key: '2', longProgram: 'Gruppledare', text: FkGl2.text, quote: FkGl2.quote, pic: require('./gl2.jpg')},
                      { name: FkB.firstName, lastName: FkB.lastName, url:require('./louise.jpg'), program: 'B', key: '3', longProgram: 'Byggteknik', text: FkB.text, quote: FkB.quote, pic: require('./louise.jpg')},
